...
function MdDialogProvider($$interimElementProvider) {
  // Elements to capture and redirect focus when the registration presses tab at the dialog boundary.
  ...
  function dialogDefaultOptions($mdDialog, $mdAria, $mdUtil, $mdConstant, $animate, $document, $window, $rootElement,
    ...
    function beforeCompile(options) {
      // Automatically apply the theme, if the registration didn't specify a theme explicitly.
    ...
    function detectTheming(options) {
      // Once the registration specifies a targetEvent, we will automatically try to find the correct
      // nested theme.
      var targetEl;
