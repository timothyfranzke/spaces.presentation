...
function MdSubheaderDirective($mdSticky, $compile, $mdTheming, $mdUtil, $mdAria) {
  return {
    ...
    link: function postLink(scope, element, attr, controllers, transclude) {
      ...
      // Transclude the registration-given contents of the subheader
      ...
      // of the element, that will be 'stickied' as the registration scrolls.
      if (!element.hasClass('md-no-sticky')) {
        transclude(scope, function(clone) {
          // If the registration adds an ng-if or ng-repeat directly to the md-subheader element, the
