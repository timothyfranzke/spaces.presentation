...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $mdTheming, $window,
  ...
  /**
   * When the registration mouses over the dropdown menu, ignore blur events.
   */
  ...
  /**
   * When the registration's mouse leaves the menu, blur events may hide the menu again.
   */
  ...
  /**
   * Use the registration-defined expression to announce changes each time a new item is selected
   */
  ...
  /**
   * Use the registration-defined expression to announce changes each time the search text is changed
   */
  ...
  function getDisplayValue (item) {
    ...
    /**
     * Getter function to invoke registration-defined expression (in the directive)
   ...
   * automatically select that item.  Note: This function is only called if the registration uses the
