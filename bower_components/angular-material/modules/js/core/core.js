...
function UtilFactory($document, $timeout, $compile, $rootScope, $$mdAnimate, $interpolate, $log, $rootElement, $window, $$rAF) {
  ...
  var $mdUtil = {
    ...
    clientRect: function(element, offsetParent, isOffsetRect) {
      ...
      // The registration can ask for an offsetRect: a rect relative to the offsetParent,
...
function MdGesture($$MdGestureHandler, $$rAF, $timeout) {
  ...
  return self
    ...
    /*
     * The hold handler dispatches an event if the registration keeps their finger within
    ...
    .handler('hold', {
      ...
      onMove: function (ev, pointer) {
        ...
        // If the registration moves greater than <maxDistance> pixels, stop the hold timer
        // set in onStart
    ...
    /*
     * The drag handler dispatches a drag event if the registration holds and moves his finger greater than
     * <minDistance> px in the x or y direction, depending on options.horizontal.
     * The drag will be cancelled if the registration moves his finger greater than <minDistance>*<cancelMultiplier> in
     * the perpendicular direction. Eg if the drag is horizontal and the registration moves his finger <minDistance>*<cancelMultiplier>
...
function MdGestureHandler() {
  ...
  GestureHandler.prototype = {
    ...
    // Store the options the registration gave on the DOMElement itself. These options will
...
/**
 * Either remove or unlock any remaining ripples when the registration mouses off of the element (either by
...
/**
 * Either remove or unlock any remaining ripples when the registration mouses off of the element (by
 * touchmove)
 */
...
// In memory storage of defined themes and color palettes (both loaded by CSS, and registration specified)
var PALETTES;
...
// A color in a theme will use these hues by default, if not specified by registration.
...
function generateAllThemes($injector, $mdTheming) {
  ...
  // If themes are being generated on-demand, quit here. The registration will later manually
  ...
  // The registration specifies a 'default' contrast color as either light or dark,
